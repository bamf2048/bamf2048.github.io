...
MAME is a program that "runs" or emulates a large library of arcade games. You can run MAME using [OpenEmu's Experimental version][openemu] or use the "official" version which is called SDL MAME for OS X compiled by r0ni aka [@sdlmame_osx](https://twitter.com/sdlmame_osx). In part 1, we'll go over how to run SDL MAME at the very barest bones.
